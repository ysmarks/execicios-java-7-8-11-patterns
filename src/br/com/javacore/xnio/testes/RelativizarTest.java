...
public class RelativizarTest {
    public static void main(String[] args) {
        Path dir = Paths.get("/home/ysmarks");
        Path classe = Paths.get("/home/ysmarks/java/Pessoa.java");
        Path pathToClasse = dir.relativize(classe);
        System.out.println(pathToClasse);

        Path absoluto1 = Paths.get("/home/ysmarks");
        Path absoluto2 = Paths.get("/usr/local");
        Path absoluto3 = Paths.get("/home/ysmarks/java/Pessoa.java");
